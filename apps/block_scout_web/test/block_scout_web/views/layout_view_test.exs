defmodule BlockScoutWeb.LayoutViewTest do
  ...
  describe "subnetwork_title/0" do
    ...
    test "use the default subnetwork title when there is no env configured for it" do
      assert LayoutView.subnetwork_title() == "Apps"
    end
  end
  ...
  @supported_chains_pattern ~s([ { "title": "RSK", "url": "https://blockscout.com/rsk/mainnet", "other?": true }, { "title": "Apps", "url": "https://blockscout.com/poa/sokol", "test_net?": true }, { "title": "POA", "url": "https://blockscout.com/poa/core" }, { "title": "LUKSO L14", "url": "https://blockscout.com/lukso/l14", "test_net?": true, "hide_in_dropdown?": true } ])
